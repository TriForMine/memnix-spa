...
export async function getTodayAPI() {
  try {
    const { data } = await axiosClient.get(`v1/cards/today`, {
      headers: {
...
export async function getEditorAPI() {
  try {
    const { data } = await axiosClient.get(`v1/decks/editor`, {
      headers: {
        'Content-Type': 'application/json',
      },
      withCredentials: true,
...
export async function getSubAPI() {
  try {
    const { data } = await axiosClient.get(`v1/decks/sub`, {
      headers: {
        'Content-Type': 'application/json',
      },
      withCredentials: true,
...
export async function getAvailableAPI() {
  try {
    const { data } = await axiosClient.get(`v1/decks/available`, {
      headers: {
        'Content-Type': 'application/json',
      },
      withCredentials: true,
...
export async function publishDeckAPI(deckID: number) {
  try {
    const { data } = await axiosClient.post(
...
export async function createDeckAPI(deckObject: Object) {
  try {
    const { data } = await axiosClient.post(`v1/decks/new`, deckObject, {
      headers: {
        'Content-Type': 'application/json',
      },
      withCredentials: true,
